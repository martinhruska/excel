...
\Abstract{
  Forest automata ara one of the formalisms recently used for analysis and verification of programs manipulating dynamic data structures.
  In the area of shape analysis, there exists a tool Forester basend of forest automata.
  ...
  The first goal has been already fulfilled and the variant of Forester using the VATA library participated in the competition SV-COMP 2015.
...
However, Forester does not currenly use the mentioned predicate abstraction but \emph{height abstraction} now %TODO
...
Forest automata are also able to handle also infinite state spaces
...
The main goals of this work were (a) to implement version of Forester tool that uses the VATA library for tree automata representation and manipulation
